...
},_cleanObject:function(b){var c=a.isArray(b)?[]:{},d=this;return a.each(b,function(e,f){b.hasOwnProperty(e)&&(["boolean","number","string"].indexOf(typeof f)>-1?c[e]=f:(a.isArray(b)||a.isPlainObject(b))&&(c[e]=d._cleanObject(f)))}),c},ready:function(){}})}(jQuery,smile);